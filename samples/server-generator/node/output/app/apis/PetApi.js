...
exports.updatePet = {
  ...
  'action': function (req,res) {
    ...
    try {
      thisAPI.updatePet(req, res, function(resMessage) {
...
exports.addPet = {
  ...
  'action': function (req,res) {
    ...
    try {
      thisAPI.addPet(req, res, function(resMessage) {
        writeResponse(res, {message: resMessage});    
      });
    } catch(e) {
...
exports.findPetsByStatus = {
  ...
  'action': function (req,res) {
    ...
    try {
      thisAPI.findPetsByStatus(req, res, function(resMessage) {
        writeResponse(res, {message: resMessage});    
      });
    } catch(e) {
...
exports.findPetsByTags = {
  ...
  'action': function (req,res) {
    ...
    try {
      thisAPI.findPetsByTags(req, res, function(resMessage) {
        writeResponse(res, {message: resMessage});    
      });
    } catch(e) {
...
exports.updatePetWithForm = {
  ...
  'action': function (req,res) {
    ...
    try {
      thisAPI.updatePetWithForm(req, res, function(resMessage) {
        writeResponse(res, {message: resMessage});    
      });
    } catch(e) {
...
exports.getPetById = {
  ...
  'action': function (req,res) {
    ...
    try {
      thisAPI.getPetById(req, res, function(resMessage) {
        writeResponse(res, {message: resMessage});    
      });
    } catch(e) {
...
exports.deletePet = {
  ...
  'action': function (req,res) {
    ...
    try {
      thisAPI.deletePet(req, res, function(resMessage) {
        writeResponse(res, {message: resMessage});    
      });
    } catch(e) {
...
exports.partialUpdate = {
  ...
  'action': function (req,res) {
    ...
    try {
      thisAPI.partialUpdate(req, res, function(resMessage) {
        writeResponse(res, {message: resMessage});    
      });
    } catch(e) {
...
exports.uploadFile = {
  ...
  'action': function (req,res) {
    try {
      thisAPI.uploadFile(req, res, function(resMessage) {
        writeResponse(res, {message: resMessage});    
      });
    } catch(e) {
